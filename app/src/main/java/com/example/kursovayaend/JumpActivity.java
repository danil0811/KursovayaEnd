...
public class JumpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StartTimeJump = findViewById(R.id.startJump);
        goToActivityJump = findViewById(R.id.GoToZashagivaniya);

        StartTimeJump.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        goToActivityJump.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JumpActivity.this, ZashagivaniyaActivity.class);
    ...
    private void startTimer(long totalTimeInMillis) {
        countDownTimer = new CountDownTimer(totalTimeInMillis, 2000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(JumpActivity.this, "Тренировка завершена", Toast.LENGTH_SHORT).show();
    ...
    private void updateTimer() {
        ...
        Toast.makeText(JumpActivity.this, timeLeftFormatted, Toast.LENGTH_SHORT).show();
    }
